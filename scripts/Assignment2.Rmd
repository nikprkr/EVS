...
#### As the age of a respondent increases, it appears more likely that a respondent will agree with the idea that mothers choosing to work outside of the home will harm their children. Also, respondents from the Othodox, Muslim, and Roman Catholic faiths seem to agree with this statement more often than those from other faiths.
...
ggplot(data = data_long_age, aes(age,values, color=new))+
  ...
  ggtitle("Age and mean response to question")
...
ggplot(data = data_long_religion, aes(religion, values, color=new))+
  ...
  ggtitle("Religion and mean response to question")
